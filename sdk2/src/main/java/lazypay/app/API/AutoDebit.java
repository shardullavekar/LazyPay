...
public class AutoDebit {
    ...
    public void start(Callback callback, JSONObject jsonObject, String accessKey, String signature, String token) {
        AutoDebitAsynch asynch = new AutoDebitAsynch(callback, jsonObject, accessKey, signature, token);
        asynch.execute();
    }

    private class AutoDebitAsynch extends AsyncTask<Void, Void, String> {
        Callback callback;
        JSONObject jsonObject;
        String accessKey, signature, token;
        public AutoDebitAsynch(Callback callback, JSONObject jsonObject, String accessKey, String signature, String token) {
